...
#ifndef _GxEPD2_266c_E2266JS0C_H_
#define _GxEPD2_266c_E2266JS0C_H_

#include <GxEPD2_EPD.h>

class GxEPD2_266c_E2266JS0C : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_266c_E2266JS0C(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
